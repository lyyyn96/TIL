	...
	<div id="page-wrapper">
		<header id="main-header">
			<hgroup>
				...
				<h2 class="master-description">${id }님 환영합니다</h2>
			</hgroup>
		</header>
		<nav id="main-navigation">
			<div class="pull-left">
				<ul class="outer-menu">
					<li class="outer-menu-item"><span class="menu-title" id="html5">HTML5</span>
						<ul class="inner-menu">
							<li class="inner-menu-item"><a href="#" target="_blank"
								onClick="window.open('chapter_13/memberInsert.html', '회원가입', 'resizeable, width=350, height=700'); return false;">
								회원가입</a></li>
							<li class="inner-menu-item"><a href="#" target="_blank"
							onClick="window.open('login.html','로그인','resizable, width=370, height=300'); return false;"> 로그인</a></li>
						</ul></li>
					<li class="outer-menu-item"><span class="menu-title">CSS3</span>
						<ul class="inner-menu">
							<li class="inner-menu-item"><a href="#" id="css_basic"> 개요</a></li>
