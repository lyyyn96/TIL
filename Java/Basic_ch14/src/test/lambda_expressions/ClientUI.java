package test.lambda_expressions;
...
public class ClientUI {
	...
	public void onCreate() {
		...
		ta.addTextListener(e->System.out.println("TextValueChanged"));
		...
		//람다식(function에 function이 들어감)
		//표현만 그런 것이고 실제로 function을 받아들이진 못함
		//딱 하나만의 Function을 받아들이는 Interface를
		//Functional Interface라고 함
		//@Functional Interface로 표현
		//이러한 Interface는 람다식을 표현 가능하다
